...
-- Completipn for props and emits
...
-- Clear the cache when menu is closed
-- https://github.com/vuejs/language-tools/discussions/4495#:~:text=cmp.event%3Aon(%27menu_closed%27%2C%20function()%0A%20%20local%20bufnr%20%3D%20vim.api.nvim_get_current_buf()%0A%20%20vim.b%5Bbufnr%5D._vue_ts_cached_is_in_start_tag%20%3D%20nil%0Aend)
